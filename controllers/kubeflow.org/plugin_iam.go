...
func (aws *AwsIAMForServiceAccount) ApplyPlugin(r *ProfileReconciler, profile *profilev2alpha1.Profile) error {
...
func (aws *AwsIAMForServiceAccount) RevokePlugin(r *ProfileReconciler, profile *profilev2alpha1.Profile) error {
	logger := r.Log.WithValues("profile", profile.Name)
