...
func (gcp *GcpWorkloadIdentity) ApplyPlugin(r *ProfileReconciler, profile *profilev2alpha1.Profile) error {
...
func (gcp *GcpWorkloadIdentity) RevokePlugin(r *ProfileReconciler, profile *profilev2alpha1.Profile) error {
	logger := r.Log.WithValues("profile", profile.Name)
