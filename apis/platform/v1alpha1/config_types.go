...
type InfrastructureSpec struct {
	...
	// Cloud provider where the cluster is running
	Provider Provider `json:"provider,omitempty"`

	// Cloud provider related configs
	ProviderConfig ProviderConfigSpec `json:"providerConfig,omitempty"`

	// Storage related configs
	Storage StorageSpec `json:"storage,omitempty"`
}

// +kubebuilder:validation:Enum=AWS;GCP;Azure;EquinixMetal
...
type ProviderConfigSpec struct {
	...
	// The OIDC issuer for your cluster
	ClusterOIDCIssuer string `json:"clusterOIDCIssuer,omitempty"`
}
...
type StorageSpec struct {
	...
	// Name of the object storage bucket to use for Kubeflow
	BucketName string `json:"bucketName,omitempty"`
}

// +kubebuilder:validation:Enum=S3;GCS;MinIO
